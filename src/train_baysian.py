...
def compute_energy_and_forces(model, batch):
    ...
    # Forward pass through PaiNN (Bayesian readout is internal)
    ...
    # Forces = -∇E
    total_F = -torch.autograd.grad(total_E.sum(), pos, create_graph=True)[0]
